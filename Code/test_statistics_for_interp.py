...
'''
def obtain_test_stats_interp(model, input_dir, downsampling_ratio = (1,5), shape_for_model = (128,128), buffer = 20):
    '''
    ...
    for file in file_list:
        ...
        for i in range(0, full_samp_img.shape[0], downsampling_ratio[0]):
            ...
            if i%downsampling_ratio[0]==0:
                i_count += 1
        deep_image = apply_model_patchwork_with_interp(model, down_image = latent_image, downsampling_ratio = downsampling_ratio, 
